...
public static Computer createComputer(String info){
    switch (info){
        case "huawei":
            ...
            computer.setName("huawei pro 16");
            computer.setPrice(5999);
            return computer;
        case "Mac":
            Computer computer2=new Mac();
            computer2.setName("MacBook pro");
            computer2.setPrice(11999);
            return computer2;
        default:
            return null;
    }
...
* **创建型模式**
  ...
  用于描述“怎样创建对象”，它的主要特点是“将对象的创建与使用分离”。GoF（四人组）书中提供了单例、原型、工厂方法、抽象工厂、建造者 5 种创建型模式。

* **结构型模式**

  用于描述如何将类或对象按某种布局组成更大的结构，GoF（四人组）书中提供了代理、适配器、桥接、装饰、外观、享元、组合 7 种结构型模式。
...
![](笔记图片资源包/customer_address.png)

在UML类图中单向关联用一个带箭头的实线表示。上图表示每个顾客都有一个地址，这通过让Customer类持有一个类型为Address的成员变量类实现。

**2，双向关联**

![](笔记图片资源包/customer_product.png)
...
![](笔记图片资源包/image-20191229173422328.png)
...
![](笔记图片资源包/image-20191229173455149.png)
...
![](笔记图片资源包/image-20191229173518926.png)
...
![](笔记图片资源包/image-20191229173539838.png)
...
![](笔记图片资源包/image-20191229173554296.png)
 ...
 * @author GeWuYou
 * @version V1.0.0
 * @ClassName SougoInput
 * @Description TODO 搜狗输入类
 * @Date 2022/8/7 11:25
 */
public class SougoInput {
    ...
    public SougoInput() {
        ...
        this.abstractSkin = defaultSkin;
    }

    public SougoInput(AbstractSkin abstractSkin) {
...
public class Client {
    public static void main(String[] args) {
        ...
        // 2、创建皮肤对象
        AbstractSkin heiMaSkin = new HeiMaSkin();
        // 3、设置皮肤类型
        sougoInput.setAbstractSkin(heiMaSkin);
        // 4、展示皮肤
        sougoInput.display();
    }
}
...
<img src="笔记图片资源包/正方形不是长方形改进.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/依赖倒转原则.png" style="zoom:100%;" />
...
<img src="笔记图片资源包/依赖倒转原则改进.png" alt="image-20191229173554296" style="zoom:70%;" />
...
<img src="笔记图片资源包/迪米特法则.png" alt="image-20191229173554296" style="zoom:80%;" />
...
<img src="笔记图片资源包/合成复用原则.png" alt="image-20191229173554296" style="zoom:80%;" />

从上面类图我们可以看到使用继承复用产生了很多子类，如果现在又有新的动力源或者新的颜色的话，就需要再定义新的类。我们试着将继承复用改为聚合复用看一下。

<img src="笔记图片资源包/合成复用原则1.png" alt="image-20191229173554296" style="zoom:80%;" />
...
3. 懒汉式-方式1（线程不安全）
   ...
   public class Singleton {
       ...
       public static Singleton getInstance() {
           ...
           //如果没有，创建一个并返回，如果类中有直接返回
           if(instance == null) {
               //在多线程环境中，线程一进入语句等待，线程2获取到cpu的执行权，也会进入到该判断里面
               //这样就会导致获取到多个实例对象，这就违背了单例模式的初衷
               instance = new Singleton();
           }
           return instance;
       }
...
<img src="笔记图片资源包/工厂设计模式引入-165863633742560.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/简单工厂模式-165863633742561.png" style="zoom:70%;" />
...
<img src="笔记图片资源包/工厂方法模式-165863633742562.png" style="zoom:70%;" />
...
<img src="笔记图片资源包/image-20200401214509176-165863633742563.png" style="zoom:67%;" />

<img src="笔记图片资源包/image-20200401222951963-165863633742564.png" style="zoom:67%;" />
...
<img src="笔记图片资源包/抽象工厂模式-165863633742565.png" style="zoom:67%;" />
...
> 思考：与spring的bean自动注入的方式相似，都是通过反射创建所需类实例，只不过该类是通过配置文件进行注入的，一次创建多次使用。
...
<img src="笔记图片资源包/JDK源码解析-165863633742566.png" style="zoom:75%;" />
...
![](笔记图片资源包/原型模式-165863633742668.png)
...
<img src="笔记图片资源包/原型模式1-165863633742567.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/原型模式2-165863633742669.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/原型模式3-165863633742670.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/image-20200413225341516-165863633742671.png" style="zoom:60%;" />
...
<img src="笔记图片资源包/建造者模式-165863633742672.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/建造者模式1-165863633742673.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/静态代理.png" style="zoom:80%;" />
...
//代理工厂		MethodInterceptor是CallBack的子接口
...
<img src="笔记图片资源包/适配器模式.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/对象适配器模式.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/装饰者模式-使用前.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/装饰者模式.png" style="zoom:75%;" />
...
<img src="笔记图片资源包/装饰者模式-jdk源码.png" style="zoom:80%;" />
...
![](笔记图片资源包/image-20200207194617620.png)
...
<img src="笔记图片资源包/桥接模式.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/外观模式.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/image-20200207234545691.png" style="zoom:60%;" />

RequestFacade类就使用了外观模式。先看结构图：

<img src="笔记图片资源包/外观模式-jdk源码解析.png" style="zoom:70%;" />
...
<img src="笔记图片资源包/image-20200208180417291.png" style="zoom:60%;" />
...
<img src="笔记图片资源包/image-20200208182322313.png" style="zoom:80%;" />

要实现该案例，我们先画出类图：

<img src="笔记图片资源包/组合模式.png" style="zoom:80%;" />
...
* 安全组合模式
  ...
  <img src="笔记图片资源包/组合模式-安全性.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/俄罗斯方块.jpeg" style="zoom:60%;" />



**先来看类图：**

<img src="笔记图片资源包/享元模式.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/image-20200208212930857.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/模板方法模式.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/image-20200210143039168.png" style="zoom:80%;" />

作为一个程序猿，开发需要选择一款开发工具，当然可以进行代码开发的工具有很多，可以选择Idea进行开发，也可以使用eclipse进行开发，也可以使用其他的一些开发工具。

<img src="笔记图片资源包/image-20200210144457478.png" style="zoom:70%;" />
...
<img src="笔记图片资源包/策略模式.png" style="zoom:80%;" />
...
<img src="../JAVA笔记/课件资料/资料-ja va设计模式（图解+框架源码分析+实战）/Java设计模式资料day04/笔记/img/image-20200211130313251.png" style="zoom:60%;" />
...
<img src="笔记图片资源包/命令模式.png" style="zoom:75%;" />
...
<img src="笔记图片资源包/责任链模式.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/状态模式前.png" style="zoom:150%;" />
...
<img src="笔记图片资源包/状态模式.png" style="zoom:150%;" />
...
<img src="笔记图片资源包/观察者模式.png" style="zoom:150%;" />
...
<img src="笔记图片资源包/image-20200214110924010.png" style="zoom:150%;" />
...
<img src="笔记图片资源包/中介者模式.png" style="zoom:70%;" />
...
* 松散耦合
  ...
  中介者模式通过把多个同事对象之间的交互封装到中介者对象里面，从而使得同事对象之间松散耦合，基本上可以做到互不依赖。这样一来，同事对象就可以独立地变化和复用，而不再像以前那样“牵一处而动全身”了。
...
<img src="笔记图片资源包/迭代器模式.png" style="zoom:150%;" />
...
<img src="笔记图片资源包/image-20200214215446638.png" style="zoom:70%;" />
...
<img src="笔记图片资源包/image-20200426233931693.png" style="zoom:67%;" />
...
<img src="笔记图片资源包/白箱备忘录模式.png" style="zoom:80%;" />
...
<img src="笔记图片资源包/黑箱备忘录模式.png" style="zoom:150%;" />
...
<img src="笔记图片资源包/image-20200215220322641.png" style="zoom:150%;" />
...
<img src="笔记图片资源包/image-20200215225227616.png" style="zoom:50%;" />
...
<img src="笔记图片资源包/解释器模式.png" style="zoom:80%;" />
...
* 编写配置文件。在类路径下编写一个名为ApplicationContext.xml的配置文件
  ...
  <img src="笔记图片资源包/image-20200429165544151.png" style="zoom:60%;" />
...
<img src="笔记图片资源包/image-20200429111324770.png" style="zoom:150%;" />
...
<img src="笔记图片资源包/image-20200429185050396.png" style="zoom:60%;" />
...
<img src="笔记图片资源包/image-20200430220155371.png" style="zoom:60%;" />
...
<img src="笔记图片资源包/image-20200429204239868.png" style="zoom:60%;" />
...
<img src="笔记图片资源包/image-20200429204700956.png" style="zoom:60%;" />
...
<img src="笔记图片资源包/image-20200429211132185.png" style="zoom:60%;" />
