...
![image-20210906105652113](笔记图片资源包/image-20210906105652113.png) 
...
![image-20210906105157409](笔记图片资源包/image-20210906105157409.png)

点击进入后，下载Source code(zip)：

![image-20210906105102668](笔记图片资源包/image-20210906105102668.png)
...
![image-20210906105858000](笔记图片资源包/image-20210906105858000.png) 

导入该项目后，查看其项目结构：

![image-20210906110014198](笔记图片资源包/image-20210906110014198.png) 
...
![image-20210906111053263](笔记图片资源包/image-20210906111053263.png) 

然后，使用IDEA将其作为一个module来导入：

1）选择项目结构选项：

![image-20210906111152447](笔记图片资源包/image-20210906111152447.png) 

然后点击导入module：

![image-20210906111259352](笔记图片资源包/image-20210906111259352.png) 

在弹出窗口中，选择nacos源码目录：

![image-20210906111422406](笔记图片资源包/image-20210906111422406.png)

然后选择maven模块，finish：

![image-20210906111519198](笔记图片资源包/image-20210906111519198.png)

最后，点击OK即可：

![image-20210906111543747](笔记图片资源包/image-20210906111543747.png)

导入后的项目结构：

![image-20210906111632336](笔记图片资源包/image-20210906111632336.png)
...
![image-20210906111941399](笔记图片资源包/image-20210906111941399.png)
...
![image-20210906112814549](笔记图片资源包/image-20210906112814549.png)

另外，课前资料也提供了下载好的安装包：

![image-20210906112920575](笔记图片资源包/image-20210906112920575.png) 



解压到任意非中文目录下，其中的bin目录中的protoc.exe可以帮助我们编译：

![image-20210906113011871](笔记图片资源包/image-20210906113011871.png)

然后将这个bin目录配置到你的环境变量path中，可以参考JDK的配置方式：

![image-20210906113552081](笔记图片资源包/image-20210906113552081.png)
...
![image-20210906113655302](笔记图片资源包/image-20210906113655302.png)
...
![image-20210906113829647](笔记图片资源包/image-20210906113829647.png)

会在nacos的consistency模块中编译出这些java代码：

![image-20210906113923430](笔记图片资源包/image-20210906113923430.png)
...
![image-20210906114035628](笔记图片资源包/image-20210906114035628.png) 

我们需要让它单机启动：

![image-20210906114143669](笔记图片资源包/image-20210906114143669.png) 

然后新建一个SpringBootApplication：

![image-20210906114220412](笔记图片资源包/image-20210906114220412.png) 

然后填写应用信息：

![image-20210906114519073](笔记图片资源包/image-20210906114519073.png)



然后运行Nacos这个main函数：

![image-20210906114705910](笔记图片资源包/image-20210906114705910.png)



将order-service和user-service服务启动后，可以查看nacos控制台：

![image-20210906151358154](笔记图片资源包/image-20210906151358154.png)
...
![image-20210922111651314](笔记图片资源包/image-20210922111651314.png)
...
![image-20210907201333049](笔记图片资源包/image-20210907201333049.png)
...
![image-20210907201612322](笔记图片资源包/image-20210907201612322.png)
...
![image-20210907213647145](笔记图片资源包/image-20210907213647145.png)
...
![image-20210907214111801](笔记图片资源包/image-20210907214111801.png)

可以看到它实现了`ApplicationListener`接口，监听Spring容器启动过程中的事件。

在监听到`WebServerInitializedEvent`（web服务初始化完成）的事件后，执行了`bind` 方法。

![image-20210907214411267](笔记图片资源包/image-20210907214411267.png)
...
![image-20210907215903335](笔记图片资源包/image-20210907215903335.png)
...
![image-20210908141019175](笔记图片资源包/image-20210908141019175.png)
...
![image-20210923185331470](笔记图片资源包/image-20210923185331470.png)
...
![image-20210922112801808](笔记图片资源包/image-20210922112801808.png)

模块结构如下：

![image-20210922112954630](笔记图片资源包/image-20210922112954630.png)

其中的com.alibaba.nacos.naming.controllers包下就有服务注册、发现等相关的各种接口，其中的服务注册是在`InstanceController`类中：

![image-20210922113158618](笔记图片资源包/image-20210922113158618.png)
...
![image-20210922141703128](笔记图片资源包/image-20210922141703128.png)
...
![image-20210922161705573](笔记图片资源包/image-20210922161705573.png)
...
![image-20210922180246555](笔记图片资源包/image-20210922180246555.png)
...
![image-20210922195603450](笔记图片资源包/image-20210922195603450.png)
...
![image-20210923214042926](笔记图片资源包/image-20210923214042926.png)
...
![image-20210922213313677](笔记图片资源包/image-20210922213313677.png)
...
![image-20210922213455549](笔记图片资源包/image-20210922213455549.png)
...
![image-20210922213829632](笔记图片资源包/image-20210922213829632.png)
...
![image-20210922221022107](笔记图片资源包/image-20210922221022107.png)
...
![image-20210922221344417](笔记图片资源包/image-20210922221344417.png)
...
![image-20210923100740065](笔记图片资源包/image-20210923100740065.png)
...
![image-20210923102824451](笔记图片资源包/image-20210923102824451.png)
...
![image-20210923153419392](笔记图片资源包/image-20210923153419392.png)
...
- 如果本地缓存没有，立即去nacos读取，`updateServiceNow(serviceName, clusters)`
  ...
  ![image-20210923161528710](笔记图片资源包/image-20210923161528710.png)

- 如果本地缓存有，则开启定时更新功能，并返回缓存结果：

  - `scheduleUpdateIfAbsent(serviceName, clusters)`

  ![image-20210923161630575](笔记图片资源包/image-20210923161630575.png)

  在UpdateTask中，最终还是调用updateService方法：

  ![image-20210923161752521](笔记图片资源包/image-20210923161752521.png)
...
![image-20210923164145915](笔记图片资源包/image-20210923164145915.png)
...
![image-20210923182429636](笔记图片资源包/image-20210923182429636.png)

这个是事件监听器接口，监听的是ServiceChangeEvent（服务变更事件）。

当服务列表变化时，就会通知我们：

![image-20210923183017424](笔记图片资源包/image-20210923183017424.png)
...
![image-20210925092845529](笔记图片资源包/image-20210925092845529.png)
...
![image-20210925103029924](笔记图片资源包/image-20210925103029924.png)
...
![image-20210925104726158](笔记图片资源包/image-20210925104726158.png)
...
![image-20210925113122759](笔记图片资源包/image-20210925113122759.png)
...
![image-20210925141507603](笔记图片资源包/image-20210925141507603.png)
...
![image-20210925115601560](笔记图片资源包/image-20210925115601560.png)

其中的spring.factories声明需要就是自动装配的配置类，内容如下：

![image-20210925115740281](笔记图片资源包/image-20210925115740281.png)

我们来看下`SentinelAutoConfiguration`这个类：

![image-20210925141553785](笔记图片资源包/image-20210925141553785.png)
...
![image-20210925115824345](笔记图片资源包/image-20210925115824345.png)

这个类实现了WebMvcConfigurer，我们知道这个是SpringMVC自定义配置用到的类，可以配置HandlerInterceptor：

![image-20210925115946064](笔记图片资源包/image-20210925115946064.png)

可以看到这里配置了一个`SentinelWebInterceptor`的拦截器。

`SentinelWebInterceptor`的声明如下：

![image-20210925120119030](笔记图片资源包/image-20210925120119030.png)

发现它继承了`AbstractSentinelInterceptor`这个类。

![image-20210925120221883](笔记图片资源包/image-20210925120221883.png)
...
![image-20210925142313050](笔记图片资源包/image-20210925142313050.png)

还有，`SentinelResourceAspect`的环绕增强方法：

![image-20210925142438552](笔记图片资源包/image-20210925142438552.png)
...
![image-20210925144355865](笔记图片资源包/image-20210925144355865.png)

看下继承关系：

![image-20210925144010507](笔记图片资源包/image-20210925144010507.png)
...
![image-20210925144233302](笔记图片资源包/image-20210925144233302.png)
...
![image-20210925101327080](笔记图片资源包/image-20210925101327080.png)
...
![image-20210925152626648](笔记图片资源包/image-20210925152626648.png)
...
![image-20210925153228036](笔记图片资源包/image-20210925153228036.png)
...
![image-20210925153719891](笔记图片资源包/image-20210925153719891.png)
...
![image-20210925163744108](笔记图片资源包/image-20210925163744108.png)
...
![image-20210925172542274](笔记图片资源包/image-20210925172542274.png)
...
![image-20210925175221211](笔记图片资源包/image-20210925175221211.png)
...
![image-20210925180522926](笔记图片资源包/image-20210925180522926.png)



就是在统计通过该节点的QPS，我们跟入看看，这里进入了DefaultNode内部：

![image-20210925180619492](笔记图片资源包/image-20210925180619492.png)
...
![image-20210925180810181](笔记图片资源包/image-20210925180810181.png)

这里有秒、分两种纬度的统计，对应两个计数器。找到对应的成员变量，可以看到：

![image-20210925180954856](笔记图片资源包/image-20210925180954856.png)
...
![image-20210925181359203](笔记图片资源包/image-20210925181359203.png)
...
![image-20210925181714605](笔记图片资源包/image-20210925181714605.png)
...
![image-20210925182127206](笔记图片资源包/image-20210925182127206.png)
...
![image-20210925210716675](笔记图片资源包/image-20210925210716675.png)
...
![image-20210925211020881](笔记图片资源包/image-20210925211020881.png)
...
![image-20210925213440686](笔记图片资源包/image-20210925213440686.png)

会调用CircuitBreaker的onRequestComplete方法。而CircuitBreaker有两个实现：

![image-20210925213939035](笔记图片资源包/image-20210925213939035.png)
