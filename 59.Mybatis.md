...
<img src="笔记图片资源包/image-20210726202410311.png" alt="image-20210726202410311" style="zoom:70%;" />

如下图所示有一个石膏娃娃，这个就是一个半成品。你可以在这个半成品的基础上进行不同颜色的涂鸦

<img src="笔记图片资源包/image-20210726202858441.png" alt="image-20210726202858441" style="zoom:70%;" />
...
<img src="笔记图片资源包/image-20210726203656847.png" alt="image-20210726203656847" style="zoom:70%;" />
...
<img src="笔记图片资源包/image-20210726204849309.png" alt="image-20210726204849309" style="zoom:80%;" />

下图是持久层框架的使用占比。

<img src="笔记图片资源包/image-20210726205328999.png" alt="image-20210726205328999" style="zoom:80%;" />
...
<img src="笔记图片资源包/image-20210726212621722.png" alt="image-20210726212621722" style="zoom:80%;" />
...
* 点击IDEA右边框的 `Database` ，在展开的界面点击 `+` 选择 `Data Source` ，再选择 `MySQL`
  ...
  <img src="笔记图片资源包/image-20210726213046072.png" alt="image-20210726213046072" style="zoom:80%;" />

* 在弹出的界面进行基本信息的填写

  <img src="笔记图片资源包/image-20210726213305893.png" alt="image-20210726213305893" style="zoom:80%;" />

* 点击完成后就能看到如下界面

  <img src="笔记图片资源包/image-20210726213541418.png" alt="image-20210726213541418" style="zoom:80%;" />

  而此界面就和 `navicat` 工具一样可以进行数据库的操作。也可以编写SQL语句

<img src="笔记图片资源包/image-20210726213857620.png" alt="image-20210726213857620" style="zoom:80%;" />
...
<img src="笔记图片资源包/image-20210726214648112.png" alt="image-20210726214648112" style="zoom:80%;" />

这里调用 `selectList()` 方法传递的参数是映射配置文件中的 namespace.id值。这样写也不便于后期的维护。如果使用 Mapper 代理方式（如下图）则不存在硬编码问题。

<img src="笔记图片资源包/image-20210726214636108.png" alt="image-20210726214636108" style="zoom:80%;" />
...
![image-20210726215339568](笔记图片资源包/image-20210726215339568.png)
...
* 定义与SQL映射文件同名的Mapper接口，并且将Mapper接口和SQL映射文件放置在同一目录下。如下图：
  ...
  <img src="笔记图片资源包/image-20210726215946951.png" alt="image-20210726215946951" style="zoom:80%;" />

* 设置SQL映射文件的namespace属性为Mapper接口全限定名

  <img src="笔记图片资源包/image-20210726220053883.png" alt="image-20210726220053883" style="zoom:80%;" />

* 在 Mapper 接口中定义方法，方法名就是SQL映射文件中sql语句的id，并保持参数类型和返回值类型一致

  <img src="笔记图片资源包/image-20210726223216517.png" alt="image-20210726223216517" style="zoom:70%;" />
...
<img src="笔记图片资源包/image-20210726221454927.png" alt="image-20210726221454927" style="zoom:80%;" />
...
注意：配置各个标签时，需要遵守前后顺序，即按上方的顶层结构的顺序进行配置
...
> 从中可以看出#{}会将其替换为？以此防止SQL注入，而${}是拼SQL语句，存在SQl注入的危险
>
> ==注意：==从上面两个例子可以看出，以后开发我们使用 #{} 参数占位符。
>
> 表名或者列名不固定时可以使用${}，但仍存在SQL注入问题
...
> * keyProperty  ：指定将获取到的主键值封装到哪儿个属性里 （实体类属性）
